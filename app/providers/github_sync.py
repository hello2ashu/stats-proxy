...
index 9583eb1..ed262d6 100644
--- a/app/scripts/github_repos_to_homepage.py
+++ b/app/scripts/github_repos_to_homepage.py
@@ -33,6 +33,16 @@ hit if the script runs on a cron and you also browse the API elsewhere.
...
+the dot off if you'd rather not surface repo visibility on the dashboard.
 ...
 import argparse
@@ -48,6 +58,17 @@ from ruamel.yaml.comments import CommentedMap, CommentedSeq
...
@@ -456,13 +477,24 @@ def resolve_icon(repo_name, language, icon_overrides, skip_verification=False):
